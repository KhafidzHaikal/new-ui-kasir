...
<body onload="window.print()">
    <h3 class="text-center">LAPORAN JURNAL PENJUALAN</h3>
    ...
    <table class="table table-striped">
        ...
        <tbody>
            <tr>
                <th>KAS</th>
                <td></td>
                <th style="text-align: right">{{ format_uang($penjualan) }}</th>
                <td></td>
            </tr>
            <tr>
                <th>Penjualan</th>
                <td></td>
                <td></td>
                <th style="text-align: right">{{ format_uang($value_penjualan) }}</th>
            </tr>
            ...
            @endforeach
            <tr>
                <th colspan="2" style="text-align: center">Total Penjualan</th>
                <th style="text-align: right">{{ format_uang($penjualan) }}</th>
                <th style="text-align: right">{{ format_uang($value_penjualan) }}</th>
            </tr>
        </tbody>
