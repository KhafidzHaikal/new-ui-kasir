        ...
        <form action={{ route('produk.store') }} method="post" class="form-horizontal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label for="tanggal_expire" class="col-lg-2 col-lg-offset-1 control-label">Tanggal
                            Kadaluarsa</label>
                        <div class="col-lg-6">
...
<script>
    ...
    function onScanSuccess(decodedText, decodedResult) {
        ...
        if (!codeScanned) {
            ...
            $('#modal-form [name=kode_produk]').val(decodedText);
            setTimeout(() => {
                // Enable the scanner after a delay
